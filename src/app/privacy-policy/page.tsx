    ...
    return <>
        ...
        <div className="bg-white p-4 rounded-3">
            ...
            <ul className="mb-3">
                ...
                <li>For the use of markuptag not require any login or signup, it is totally free to use.</li>
            </ul>

            <h3 className="mb-3 h3">Privacy Policy for markuptag</h3>
            <p>At markuptag, accessible at <a href="https://www.markuptag.com/">www.markuptag.com</a>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by <b>MarkupTag</b> and how we use it.</p>
            ...
            <p>However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – <a href="https://policies.google.com/technologies/ads" target="_blank">https://policies.google.com/technologies/ads</a></p>
            ...
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of <b>MarkupTag</b>.</p>
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on markuptag, which are sent directly to users browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and to personalize the advertising content that you see on websites that you visit.</p>

            <h3>Third Part of Privacy Policies</h3>
